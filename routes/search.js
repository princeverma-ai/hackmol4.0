    ...
    <body>
        ...
        <div class="col" style="display: inline-block;">
            <div class="card mx-2 mb-2 mt-4 pt-3 "
                style="width: 53rem;  min-height: 300px; max-height: max-content; background-color: rgba(139, 180, 197, 0.836); ">
                <div class="card-body">
        ...
        <div class="card mx-1 mb-2 pt-3"
            style="width: 29rem; min-height: 100vw; max-height:max-content;  float: right; background-color: rgba(139, 180, 197, 0.836);">
            <div class="card-body">
        ...
        <div class="row">
            <div class="card mx-2 ml-2 mt-2 py-3" style="width: 26rem; background-color: rgba(139, 180, 197, 0.836);">
                <div class="card-body">
        ...
        <div class="card mx-2 ml-2 mt-2 py-3"
            style="width: 53rem; background-color: rgba(139, 180, 197, 0.836); min-height: 350px; max-height: max-content;">
            <div class="card-body">
        ...
        <div class="card mx-2 ml-2 mt-2 py-3"
            style="width: 53rem ; min-height: 100vw;max-height: max-content; background-color: rgba(139, 180, 197, 0.836);">
            <div class="card-body">
